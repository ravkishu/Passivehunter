...
def error_handler(url):
    ...
    try:
        res = requests.get(url,timeout=30 , verify=True)
    except requests.ConnectionError as e:
        print("\u001b[31;1mOOPS!! Connection Error. Make sure you are connected to Internet.\u001b[0m")
        print("\u001b[31;1mIf you think this is a bug or unintentional behaviour. Report here : https://github.com/devanshbatham/Passivehunter/issues\u001b[0m")
        print("\u001b[0m")
        sys.exit()
